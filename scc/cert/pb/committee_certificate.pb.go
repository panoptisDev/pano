...
const file_committee_certificate_proto_rawDesc = "" +
	"\n" +
	"\x1bcommittee_certificate.proto\x12\x13pano.scc.cert.proto\x1a\x0fsignature.proto\"\xc7\x01\n" +
	"\x14CommitteeCertificate\x12F\n" +
	...
	"\x06period\x18\x03 \x01(\x04R\x06period\x125\n" +
	"\amembers\x18\x04 \x03(\v2\x1b.pano.scc.cert.proto.MemberR\amembers\"v\n" +
	"\x06Member\x12\x1c\n" +
