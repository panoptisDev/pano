...
const file_proposal_proto_rawDesc = "" +
	"\n" +
	"\x0eproposal.proto\x12\x11pano.inter.proto\x1a\x11transaction.proto\"\xac\x01\n" +
	"\bProposal\x12\x16\n" +
	"\x06number\x18\x01 \x01(\x04R\x06number\x12\x1f\n" +
	"\vparent_hash\x18\x02 \x01(\fR\n" +
	"parentHash\x12#\n" +
	"\rrandao_reveal\x18\x03 \x01(\fR\frandaoReveal\x12B\n" +
	"\ftransactions\x18\x04 \x03(\v2\x1e.pano.inter.proto.TransactionR\ftransactionsB\x06Z\x04.;pbb\x06proto3"
