...
const file_payload_proto_rawDesc = "" +
	"\n" +
	"\rpayload.proto\x12\x10pano.inter.proto\x1a\x0eproposal.proto\"\xd7\x01\n" +
	"\aPayload\x12\x18\n" +
	...
	"\bproposal\x18\x04 \x01(\v2\x1a.pano.inter.proto.ProposalH\x00R\bproposal\x88\x01\x01B\v\n" +
